...
/***
 * 
 * @desc TO use driver for different browser
 *
 */
public class DriverFactory {
	...
	/**
	 * @desc get the path of data resource
	 * @param strDataSourcePath
	 * @return DataSourcePath
	 */
	public static String getDataSourcePath(String strDataSourceName) {
		String strDataSourcePath = "";
		try {
			p = ConfigUtils.getProperties(config);
		} catch (IOException e) {
			e.printStackTrace();
		...
		strDataSourcePath = System.getProperty("user.dir") + File.separator + p.getProperty("DataSourcePath")
				+ strDataSourceName;
		return strDataSourcePath;
	}

	
	/**
	 * @desc get the path of locator
	 * @param strLocatorName
	 * @return
	 */
	public static String getLocatorPath(String strLocatorName) {
		String strLocatorPath = "";
		try {
			p = ConfigUtils.getProperties(config);
		} catch (IOException e) {
			e.printStackTrace();
		...
		strLocatorPath = System.getProperty("user.dir") + File.separator + p.getProperty("LocatorRepositoryPath")
				+ strLocatorName;
		return strLocatorPath;
	}
